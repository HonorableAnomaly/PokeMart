          ...
          <nav class="navbar navbar-top">
            <div class="container navbar-container">
              <div>
                <ul class="social">
                  <li>
                    <a href=""><i class="fa fa-phone"></i>+1 333 987 6543</a>
                  </li>
                  <li>
                    <a href=""><i class="fa fa-envelope"></i> pokemart@pokemart.com</a>
                  </li>
                </ul>
              </div>
              <div>
